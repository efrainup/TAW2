  ...
  <body>
    ...
    <div id="wrapper">
       ...
       <!-- Collect the nav links, forms, and other content for toggling -->
        <div class="collapse navbar-collapse navbar-ex1-collapse">
          <ul class="nav navbar-nav side-nav">
            <li class="active"><a href="index.html"><i class="icon-dashboard"></i> te amo osita</a></li>
      ...
      <div id="page-wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
            <h1>Bienvenidos <small>Sistema Para Usuario Administrador</small></h1>
            <ol class="breadcrumb">
              <li class="active"><i class="icon-dashboard"></i> Saludos</li>
            </ol>
