       ...
       <!-- Collect the nav links, forms, and other content for toggling -->
        <div class="collapse navbar-collapse navbar-ex1-collapse">
          <ul class="nav navbar-nav side-nav">
            ...
            <li class="dropdown">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="icon-pencil"></i> Unidades <b class="caret"></b></a>
              <ul class="dropdown-menu">
                <li><a class="icon-user" href="alta-alumno.php">Alta Unidad</a></li>
